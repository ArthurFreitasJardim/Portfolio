    ...
    <FooterContainer>
      ...
      <SocialIcons>
        <a
          ...
          href="mailto:arthurjardimfreitas@gmail.com"
          target="_blank"
        ...
        <a
          href="https://github.com/ArthurFreitasJardim"
          target="_blank"
          rel="noopener noreferrer"
        >
        ...
        <a
          href= "https://www.linkedin.com/in/arthur-freitas-jardim-075a95289/"
          target="_blank"
          rel="noopener noreferrer"
        >
          <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
        ...
        <a
          href="https://wa.me/5531982169130"
          target="_blank"
          rel="noopener noreferrer"
        >
          <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="24 24" fill="currentColor">
